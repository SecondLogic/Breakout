...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        KeybindListener keyBinds = new KeybindListener(scene);
        ...
        Task gameLoop = new Task<Void>() {
            ...
            protected Void call() throws Exception {
                ...
                while (!this.isCancelled()) {
                    ...
                    // Move Platform
                    if (keyBinds.isPressed(KeyCode.A) || keyBinds.isPressed(KeyCode.LEFT)) {
                        platformPos[0] = Math.max(0, platformPos[0] - deltaTime * PLATFORM_SPEED);
                    }
                    else if (keyBinds.isPressed(KeyCode.D) || keyBinds.isPressed(KeyCode.RIGHT)) {
